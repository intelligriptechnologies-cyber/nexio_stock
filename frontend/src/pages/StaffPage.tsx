                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          <button
                            ...
                            className={`group flex h-9 items-center justify-center gap-1.5 rounded-xl px-4 text-xs font-bold tracking-wide shadow-sm transition-all duration-200 hover:-translate-y-0.5 active:scale-95 ${
                              s.is_active
...
function CreateCard({
  ...
  return (
    <form
      onSubmit={submit}
      className="flex flex-col gap-6 rounded-[24px] border border-slate-200/50 bg-white/60 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.02)] backdrop-blur-xl h-fit"
    >
      ...
      <button
        type="submit"
        disabled={busy}
        className="mt-2 flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-action px-6 text-sm font-bold tracking-wide text-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[var(--color-action)]/30 active:scale-95 disabled:pointer-events-none disabled:opacity-50"
      >
  ...
  return (
    <label className="flex flex-col gap-1.5 text-xs font-semibold uppercase tracking-wider text-slate-500">
      ...
      <input
        ...
        className={`h-11 w-full rounded-xl border bg-white/50 px-4 text-sm font-medium normal-case text-slate-700 shadow-sm outline-none transition-all hover:bg-white focus:ring-1 ${
          error
...
function ResetPinButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      onClick={onClick}
      className="group flex h-9 items-center justify-center gap-1.5 rounded-xl bg-white px-4 text-xs font-semibold tracking-wide text-slate-600 shadow-sm ring-1 ring-slate-200 transition-all duration-200 hover:-translate-y-0.5 hover:bg-slate-50 hover:shadow-md active:scale-95"
    >
